...
1. С помощью команды man mc прочитала документацию про командную оболочку.
![Выделение ](image/F3.png){#fig:001 width=70%}
...
лов, получение информации о размере и правах доступа на файлы и/или каталоги
и т.п.)
![Основные команды](image/основные команды.png){#fig:002 width=70%}
4. Выполняю основные команды меню левой (или правой) панели. Степень
подробности вывода информации о файлах - полное.
...
– переход в домашний каталог;
– анализ файла меню и файла расширений.
![Повторение команды](image/повторение команды.png){#fig:003 width=70%}
![Сравнение каталогов](image/сравнение каталогов.png){#fig:004 width=70%}
7. Вызываю подменю Настройки . Освойте операции, определяющие структуру экрана mc
(Full screen, Double Width, Show Hidden Files и т.д.)ю
7.3.2. Задание по встроенному редактору mc
1. Создаю текстовый файл text.txt.
![Создание файла](image/text.txt.png){#fig:005 width=70%}
2. Открываю этот файл с помощью встроенного в mc редактора.
3. У меня не получилось вставить текст из интернета, думаю проблема в переназаначении горячих клавиш.
![Работа в текстовом редакторе](image/mcedit.png){#fig:006 width=70%}
4. Проделываю с текстом следующие манипуляции, используя горячие клавиши:
4.1. Удаляю строку текста.
4.2. Выделяю фрагмент текста и скопируйте его на новую строку.
4.3. Выделяю фрагмент текста и перенесите его на новую строку.
4.4. Сохраняю файл.
...
5. Открываю файл с исходным текстом на некотором языке программирования (напри-
мер C или Java)
6. Используя меню редактора, включаю подсветку синтаксиса, если она не включена.

# Выводы

В ходе лабораторной работы я освоила основных возможностей командной оболочки Midnight Commander, приобрела навыки практической работы по просмотру каталогов и файлов; манипуляций с ними.
